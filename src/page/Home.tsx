          ...
          <div className='descriptive_para'>
            <div className='para_left'>
                <div className='para_box_left'>
                  <div> <p className='text_para_box'>Máy tính laptop là thiết bị công nghệ được rất nhiều người dùng 
            ...
            <div className='para_right'>
                ...
                <div className='list_para_box_right'>
                      ...
                      <div className='list_news1_text'>
                        <a href="/post" >Cách kết nối máy tính bảng với màn hình máy tính chi tiết nhất</a>
